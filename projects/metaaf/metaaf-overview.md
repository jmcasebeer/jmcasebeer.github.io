...
<center>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/iM2t5D2caBI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>

If you use ideas or code from this work, pleace cite our paper <d-cite key="casebeer2022metaaf">:
...
- [Long video](https://www.youtube.com/watch?v=iM2t5D2caBI)
...
We release code and model checkpoints using the `metaaf` python package developed for this work. For demos of the code, setup instructions, and more, check out the [GitHub repo](https://github.com/adobe-research/MetaAF). To listen to model outputs, head to the [**demo page**](#demos). We published an early version of these results in <d-cite key="casebeer2021auto">.
...
Demos for a single universal model evaluated on single-talk, double-talk, double-talk with a path change, and double-talk with nonlinearities are at the [**demo page**](#demos).
...
Demos for constrained and unconstrained filters on the [**demo page**](#demos).
...
Demos for one, four and eight microphone configurations on the [**demo page**](#demos).
...
Demos for a single universal model evaluated on diffuse and directional interferers are at the [**demo page**](#demos).
